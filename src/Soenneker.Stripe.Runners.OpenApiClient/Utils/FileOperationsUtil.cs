...
namespace Soenneker.Stripe.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string? filePath = await _fileDownloadUtil.Download("https://raw.githubusercontent.com/stripe/openapi/refs/heads/master/openapi/spec3.json",
        ...
        await _processUtil.Start("kiota", gitDirectory, $"kiota generate -l CSharp -d \"{targetFilePath}\" -o src/{Constants.Library} -c StripeOpenApiClient -n {Constants.Library} --ebc --cc",
